...
public class Pin{
    ...
    public static Pin genererPin(Utilisateur utilisateur , String type , Reference[] references) throws Exception{
        Timestamp currentTimes = Util.getCurrentTimestamp();
        Reference ref = Reference.getByType(references, type);
        return new Pin(Util.generateRandomPin(6) , Util.addDurationToTimestamp(currentTimes, (float) ref.getDuree()),utilisateur);
    }
