...
public class Utilisateur {
    ...
    public static boolean sendEmail(String sender, String pwdSender, String receiver, String content) {
    ...
    public static Utilisateur getByEmailAndPassword(Connection connection, String email, String password) {
