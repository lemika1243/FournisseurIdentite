  ...
  "properties" : {
    ...
    "type" : {
      ...
      "enum" : [ "login", "pin" ]
            ...
            defs["api_reinitialisation_body"] = {
  "type" : "object",
  "properties" : {
    "email" : {
      "type" : "string",
  ...
  "properties" : {
    ...
    "date_expiration" : {
      ...
      "format" : "date-time"
            ...
            defs["Reference_reinitialisation"] = {
  "type" : "object",
  "properties" : {
    "id" : {
      "type" : "integer"
    ...
    "type" : {
      "$ref" : "#/components/schemas/Type_reference"
    },
    "duree" : {
      "type" : "integer"
    }
          ...
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Default"><a href="#api-Default">API Methods - Default</a></li>
                    <li data-group="Default" data-name="apiInscriptionPost" class="">
                      <a href="#api-Default-apiInscriptionPost">apiInscriptionPost</a>
                    </li>
                    <li data-group="Default" data-name="apiLoginPost" class="">
                      <a href="#api-Default-apiLoginPost">apiLoginPost</a>
                    </li>
                    <li data-group="Default" data-name="apiReinitialisationPost" class="">
                      <a href="#api-Default-apiReinitialisationPost">apiReinitialisationPost</a>
                    </li>
                    <li data-group="Default" data-name="apiUpdateInfoPut" class="">
                      <a href="#api-Default-apiUpdateInfoPut">apiUpdateInfoPut</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>Documentation des endpoints pour l'inscription, le login, la réinitialisation de compte et la mise à jour des informations utilisateur.</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Default">
                  <h1>Default</h1>
                    <div id="api-Default-apiInscriptionPost">
                      <article id="api-Default-apiInscriptionPost-0" data-group="User" data-name="apiInscriptionPost" data-version="0">
                        <div class="pull-left">
                          <h1>apiInscriptionPost</h1>
                          <p>Inscription d&#x27;un nouvel utilisateur</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Permet d&#x27;inscrire un nouvel utilisateur en fournissant son email et son mot de passe.
</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/api/inscription</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-apiInscriptionPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-apiInscriptionPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-apiInscriptionPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-apiInscriptionPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-apiInscriptionPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-apiInscriptionPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-apiInscriptionPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-apiInscriptionPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-apiInscriptionPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-apiInscriptionPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-apiInscriptionPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-apiInscriptionPost-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X POST\
-H "Content-Type: application/json"\
"http://localhost:8080/api/inscription"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-apiInscriptionPost-0-java">
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        Api_inscription_body body = ; // Api_inscription_body | 
        try {
            apiInstance.apiInscriptionPost(body);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#apiInscriptionPost");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-apiInscriptionPost-0-android">
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-apiInscriptionPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Default-apiInscriptionPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Api_inscription_body *body = ; // 

DefaultApi *apiInstance = [[DefaultApi alloc] init];

// Inscription d'un nouvel utilisateur
[apiInstance apiInscriptionPostWith:body
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Default-apiInscriptionPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ApiUtilisateur = require('api_utilisateur');

var api = new ApiUtilisateur.DefaultApi()
var body = ; // {{Api_inscription_body}} 
...
api.apiInscriptionPost(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Default-apiInscriptionPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-apiInscriptionPost-0-csharp">
...
namespace Example
{
    public class apiInscriptionPostExample
    {
        public void main()
        {

            var apiInstance = new DefaultApi();
            var body = new Api_inscription_body(); // Api_inscription_body | 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.apiInscriptionPost: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-apiInscriptionPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiDefaultApi();
$body = ; // Api_inscription_body | 

try {
    $api_instance->apiInscriptionPost($body);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->apiInscriptionPost: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-apiInscriptionPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::DefaultApi;

my $api_instance = WWW::SwaggerClient::DefaultApi->new();
my $body = WWW::SwaggerClient::Object::Api_inscription_body->new(); # Api_inscription_body | 

eval { 
    $api_instance->apiInscriptionPost(body => $body);
};
if ($@) {
    warn "Exception when calling DefaultApi->apiInscriptionPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-apiInscriptionPost-0-python">
...
try: 
    # Inscription d'un nouvel utilisateur
    api_instance.api_inscription_post(body)
except ApiException as e:
    print("Exception when calling DefaultApi->apiInscriptionPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/api_inscription_body"
      }
    }
  },
  "required" : true
                                  ...
                                  var result = $('#d2e199_apiInscriptionPost_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_apiInscriptionPost_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 201 - Inscription réussie. Un email contenant un lien de validation a été envoyé. </h3>
                      ...
                      <hr>
                    <div id="api-Default-apiLoginPost">
                      <article id="api-Default-apiLoginPost-0" data-group="User" data-name="apiLoginPost" data-version="0">
                        <div class="pull-left">
                          <h1>apiLoginPost</h1>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Première étape : Vérifie les identifiants de connexion.   Deuxième étape : Valide le code PIN pour l&#x27;authentification.
</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/api/login</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-apiLoginPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-apiLoginPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-apiLoginPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-apiLoginPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-apiLoginPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-apiLoginPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-apiLoginPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-apiLoginPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-apiLoginPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-apiLoginPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-apiLoginPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-apiLoginPost-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X POST\
-H "Content-Type: application/json"\
"http://localhost:8080/api/login"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-apiLoginPost-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi();
        Api_login_body body = ; // Api_login_body | 
        try {
            apiInstance.apiLoginPost(body);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#apiLoginPost");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-apiLoginPost-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-apiLoginPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Default-apiLoginPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Api_login_body *body = ; // 

DefaultApi *apiInstance = [[DefaultApi alloc] init];

// Connexion utilisateur
[apiInstance apiLoginPostWith:body
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-Default-apiLoginPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ApiUtilisateur = require('api_utilisateur');

var api = new ApiUtilisateur.DefaultApi()
var body = ; // {{Api_login_body}} 
...
api.apiLoginPost(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Default-apiLoginPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-apiLoginPost-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class apiLoginPostExample
    {
        public void main()
        {
            ...
            var apiInstance = new DefaultApi();
            var body = new Api_login_body(); // Api_login_body | 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.apiLoginPost: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-apiLoginPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $api_instance->apiLoginPost($body);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->apiLoginPost: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-apiLoginPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::DefaultApi;

my $api_instance = WWW::SwaggerClient::DefaultApi->new();
my $body = WWW::SwaggerClient::Object::Api_login_body->new(); # Api_login_body | 

eval { 
    $api_instance->apiLoginPost(body => $body);
};
if ($@) {
    warn "Exception when calling DefaultApi->apiLoginPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-apiLoginPost-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Connexion utilisateur
    api_instance.api_login_post(body)
except ApiException as e:
    print("Exception when calling DefaultApi->apiLoginPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_apiLoginPost_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_apiLoginPost_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - Authentification réussie. Un token est retourné pour les requêtes futures. </h3>
                            ...
                            <h3> Status: 401 - Échec de l&#x27;authentification. Email ou mot de passe incorrect. </h3>
                      ...
                      <hr>
                    <div id="api-Default-apiReinitialisationPost">
                      <article id="api-Default-apiReinitialisationPost-0" data-group="User" data-name="apiReinitialisationPost" data-version="0">
                        <div class="pull-left">
                          <h1>apiReinitialisationPost</h1>
                          <p>Réinitialisation d&#x27;un compte bloqué</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Première étape : Envoie un email pour réinitialiser le compte avec un nouveau mot de passe.   Deuxième étape : Valide le lien de réinitialisation.
</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/api/reinitialisation</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-apiReinitialisationPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-apiReinitialisationPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-apiReinitialisationPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-apiReinitialisationPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-apiReinitialisationPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-apiReinitialisationPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-apiReinitialisationPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-apiReinitialisationPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-apiReinitialisationPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-apiReinitialisationPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-apiReinitialisationPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-apiReinitialisationPost-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X POST\
-H "Content-Type: application/json"\
"http://localhost:8080/api/reinitialisation"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi();
        Api_reinitialisation_body body = ; // Api_reinitialisation_body | 
        try {
            apiInstance.apiReinitialisationPost(body);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#apiReinitialisationPost");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Api_reinitialisation_body *body = ; // 

DefaultApi *apiInstance = [[DefaultApi alloc] init];

// Réinitialisation d'un compte bloqué
[apiInstance apiReinitialisationPostWith:body
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ApiUtilisateur = require('api_utilisateur');

var api = new ApiUtilisateur.DefaultApi()
var body = ; // {{Api_reinitialisation_body}} 
...
api.apiReinitialisationPost(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class apiReinitialisationPostExample
    {
        public void main()
        {

            var apiInstance = new DefaultApi();
            var body = new Api_reinitialisation_body(); // Api_reinitialisation_body | 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.apiReinitialisationPost: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiDefaultApi();
$body = ; // Api_reinitialisation_body | 

try {
    $api_instance->apiReinitialisationPost($body);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->apiReinitialisationPost: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::DefaultApi;

my $api_instance = WWW::SwaggerClient::DefaultApi->new();
my $body = WWW::SwaggerClient::Object::Api_reinitialisation_body->new(); # Api_reinitialisation_body | 

eval { 
    $api_instance->apiReinitialisationPost(body => $body);
};
if ($@) {
    warn "Exception when calling DefaultApi->apiReinitialisationPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-apiReinitialisationPost-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Réinitialisation d'un compte bloqué
    api_instance.api_reinitialisation_post(body)
except ApiException as e:
    print("Exception when calling DefaultApi->apiReinitialisationPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/api_reinitialisation_body"
      }
    }
  },
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_apiReinitialisationPost_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_apiReinitialisationPost_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - Réinitialisation réussie. Un email de validation a été envoyé. </h3>
                      ...
                      <hr>
                    <div id="api-Default-apiUpdateInfoPut">
                      <article id="api-Default-apiUpdateInfoPut-0" data-group="User" data-name="apiUpdateInfoPut" data-version="0">
                        <div class="pull-left">
                          <h1>apiUpdateInfoPut</h1>
                          <p>Mise à jour des informations utilisateur</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Permet de mettre à jour les informations utilisateur, comme le mot de passe.   Requiert un token d&#x27;authentification dans le header.
</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/api/updateInfo</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-apiUpdateInfoPut-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-apiUpdateInfoPut-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-apiUpdateInfoPut-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-apiUpdateInfoPut-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-apiUpdateInfoPut-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-apiUpdateInfoPut-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-apiUpdateInfoPut-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-apiUpdateInfoPut-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-apiUpdateInfoPut-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-apiUpdateInfoPut-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-apiUpdateInfoPut-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-apiUpdateInfoPut-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X PUT\
-H "Content-Type: application/json"\
"http://localhost:8080/api/updateInfo"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi();
        Api_updateInfo_body body = ; // Api_updateInfo_body | 
        try {
            apiInstance.apiUpdateInfoPut(body);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#apiUpdateInfoPut");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Api_updateInfo_body *body = ; // 

DefaultApi *apiInstance = [[DefaultApi alloc] init];

// Mise à jour des informations utilisateur
[apiInstance apiUpdateInfoPutWith:body
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ApiUtilisateur = require('api_utilisateur');

var api = new ApiUtilisateur.DefaultApi()
var body = ; // {{Api_updateInfo_body}} 
...
api.apiUpdateInfoPut(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class apiUpdateInfoPutExample
    {
        public void main()
        {

            var apiInstance = new DefaultApi();
            var body = new Api_updateInfo_body(); // Api_updateInfo_body | 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.apiUpdateInfoPut: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiDefaultApi();
$body = ; // Api_updateInfo_body | 

try {
    $api_instance->apiUpdateInfoPut($body);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->apiUpdateInfoPut: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::DefaultApi;

my $api_instance = WWW::SwaggerClient::DefaultApi->new();
my $body = WWW::SwaggerClient::Object::Api_updateInfo_body->new(); # Api_updateInfo_body | 

eval { 
    $api_instance->apiUpdateInfoPut(body => $body);
};
if ($@) {
    warn "Exception when calling DefaultApi->apiUpdateInfoPut: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-apiUpdateInfoPut-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Mise à jour des informations utilisateur
    api_instance.api_update_info_put(body)
except ApiException as e:
    print("Exception when calling DefaultApi->apiUpdateInfoPut: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/api_updateInfo_body"
      }
    }
  },
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_apiUpdateInfoPut_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_apiUpdateInfoPut_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - Mise à jour réussie. </h3>
                            ...
                            <h3> Status: 401 - Non autorisé. Token invalide ou manquant. </h3>
